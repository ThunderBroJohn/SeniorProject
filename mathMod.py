...
def math_module(textInput):#QT
    ...
    if(mathType == "subtract"): 
        ...
        if(right == 0):
            ...
            solution = left / right
    elif(mathType == "intDivison"):#python is having a lot of trouble with this. sometimes works
        if(right == 0):
            engine.say("Can not divide by 0")
            engine.runAndWait()
            return None
    ...
    elif(mathType == "modDivide"):#python is having a lot of trouble with this. sometimes works 
        if(right == 0):
            engine.say("Can not divide by 0")
            engine.runAndWait()
            return None
